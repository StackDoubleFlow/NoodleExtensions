...
MAKE_HOOK_MATCH(InstallBindings, &GameplayCoreInstaller::InstallBindings, void, GameplayCoreInstaller *self) {
    ...
    BeatmapObjectSpawnControllerHelpers::GetNoteJumpValues(self->sceneSetupData->playerSpecificSettings, difficultyBeatmap->get_noteJumpStartBeatOffset(), ByRef(NECaches::noteJumpValueType), ByRef(NECaches::noteJumpValue));
